...
def diffcoef(x, a1, a2, w1, w2, delta2):
    ...
    diff1 = outer(delta1, append(x, 1)) + LAMBDA*w1
    diff2 = outer(delta2, append(tanh(a1), 1)) + LAMBDA*w2
    return (diff1, diff2)
