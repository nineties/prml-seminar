...
train_t0 = train_y > train_x + 6
train_t1 = logical_and(train_y > -0.5*train_x + 2, logical_not(train_t0))
train_t2 = logical_and(train_y > 2*train_x - 20, logical_not(logical_or(train_t0, train_t1)))
train_t3 = logical_and(train_y > train_x - 6, logical_not(logical_or(train_t0, logical_or(train_t1, train_t2))))
train_t4 = logical_not(logical_or(train_t0, logical_or(train_t1, logical_or(train_t2, train_t3))))
train_t = array([train_t0, train_t1, train_t2, train_t3, train_t4]).T

color = train_t.dot(array([1,2,3,4,5]))

xlim(xmin, xmax)
ylim(ymin, ymax)
scatter(train_x, train_y, c=color, s=50, cmap=cm.gist_rainbow)
title("Training data")
savefig("fig6-3-training.png")
